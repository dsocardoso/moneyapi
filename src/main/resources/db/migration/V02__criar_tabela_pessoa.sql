...
INSERT INTO pessoa (nome, logradouro, numero, complemento, bairro, cep, cidade, estado, ativo) values ('Diego Cardoso', 'Avenida Jose Andre de Moraes', '1143', 'Apto 10', 'Jd. Monte Alegre', '06.755.260', 'Taboão da Serra', 'SP', true);
